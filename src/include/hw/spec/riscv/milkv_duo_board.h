...
#ifndef _SRC__INCLUDE__HW__SPEC__RISCV__MILKV_DUO_BOARD_H_
#define _SRC__INCLUDE__HW__SPEC__RISCV__MILKV_DUO_BOARD_H_
...
#endif /* _SRC__INCLUDE__HW__SPEC__RISCV__MILKV_DUO_BOARD_H_ */
